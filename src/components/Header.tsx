        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between h-16 md:h-20">
            ...
            <Link to="/" className="flex items-center gap-2">
              <img src="/logo.png" alt="KelsMall" className="h-10 md:h-12 w-auto object-contain" />
              <span className="font-display font-bold text-xl md:text-2xl tracking-tight text-foreground">KelsMall</span>
            </Link>
