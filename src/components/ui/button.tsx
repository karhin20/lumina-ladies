  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 font-body",
  {
    variants: {
      variant: {
        ...
        hero: "bg-primary text-primary-foreground hover:bg-wine shadow-elevated hover:shadow-glow tracking-wide uppercase text-xs",
        gold: "bg-accent text-accent-foreground hover:bg-gold shadow-soft hover:shadow-glow tracking-wide uppercase text-xs",
        elegant: "border-2 border-primary bg-transparent text-primary hover:bg-primary hover:text-primary-foreground tracking-wide uppercase text-xs",
      },
      size: {
