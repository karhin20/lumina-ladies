        ...
        <div className="grid md:grid-cols-2 gap-12 md:gap-20 items-center">
          ...
          <div>
            ...
            <div className="space-y-4 text-muted-foreground mb-8">
              <p>
                Founded in 2019, Lumière was born from a desire to bring together the finest lighting designs with carefully curated beauty and lifestyle products for the modern woman.
              </p>
              <p>
